...
export default function DetailsCard({ passwordEntry }) {
    ...
    <div className="card bg-base-100 w-full max-w-md shadow-sm rounded-md">
      <figure className="p-2 bg-base-200">
        <div className="h-10 w-full flex justify-start items-center gap-4">
          ...
          <h2 className="card-title">{passwordEntry.username}</h2>
        </div>
        <span
          role="button"
        ...
        <fieldset className="fieldset">
          ...
          <div className="flex flex-row items-center">
            ...
            <span
              ...
              data-tip="Go to site"
              onClick={() => {
                window.open(passwordEntry.website, "_blank", "noopener,noreferrer");
              }}
            >
              <svg
                aria-hidden="true"
